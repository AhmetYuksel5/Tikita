...
| `hakedisSheetE2E.mjs` | 💼 haftalık hakediş ekranı: başlık yalnız "N. hafta", tarih aralığı/"gönderilmedi" yok, simge nötr (🫰 hiçbir yerde yok), özet Ciro · Tikita ödemesi · Hakedişin, sütun başlıkları açıklama · ciro · hakediş; SATIŞ ve TAHSİLAT ayrı satır (satışsız kalenin tahsilatı da görünür, başka haftanın satışına gelen tahsilat hangi günün satışı olduğunu yazar), satış satırı dokununca ürün ürün açılır; nakit kutusu Gerilla satışları · Kale satışları; geçmiş dönemler yok |
